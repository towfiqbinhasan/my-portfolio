...
export default function About() {
  return (
    <section className="py-14 sm:py-24 px-5 sm:px-6 max-w-4xl mx-auto">
      <motion.h2
        initial={{ opacity: 0, y: 20 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true }}
        transition={{ duration: 0.6 }}
        className="text-2xl xs:text-3xl font-bold mb-6 text-center"
      >
      ...
      <motion.p
        ...
        className="text-sm sm:text-base text-gray-400 text-center leading-relaxed"
      >
